...
async function upgradeAsync({
  ...
  await packageManager.addAsync(`expo@^${targetSdkVersionString}`); // Remove sdkVersion from app.json
  ...
  try {
    ...
    if (rootConfig.expo.sdkVersion && rootConfig.expo.sdkVersion !== 'UNVERSIONED') {
      ...
      (0, _log().default)(_chalk().default.underline.bold('Removing deprecated sdkVersion property from the app.json...'));
      await ConfigUtils().writeConfigJsonAsync(projectRoot, {
        sdkVersion: undefined
      });
    }
  } catch (_) {} // Evaluate project config (app.config.js)
  ...
  if (!_xdl().Versions.gteSdkVersion(currentExp, targetSdkVersionString) && currentExp.sdkVersion !== 'UNVERSIONED') {
    ...
    (0, _log().default)(_chalk().default.underline.bold("Please manually delete the sdkVersion in your project's app.config..."));
  }
