...
async function selectAdhocProvisioningProfile(appleContext, udids, bundleIdentifier, distCertSerialNumber, options = {}) {
  const spinner = (0, _ora().default)(`Handling Adhoc provisioning profiles on Apple Developer Portal...`).start();
  const args = ['--apple-id', appleContext.appleId, '--apple-password', appleContext.appleIdPassword, appleContext.team.id, udids, bundleIdentifier, distCertSerialNumber];
