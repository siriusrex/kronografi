...
function getEntryPoint(projectRoot, entryFiles, platforms, mode = 'development') {
...
function getEntryPointWithExtensions(projectRoot, entryFiles, extensions, mode = 'development') {
    const { exp, pkg } = Config_1.getConfig(projectRoot, { skipSDKVersionRequirement: true, mode });
