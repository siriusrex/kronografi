...
exports.getProjectConfigAsync = getProjectConfigAsync;
 ...
 */
async function getProjectConfigAsync(projectRoot, options) {
  let {
    mode
  } = options;
  ...
  return (0, _config().getConfig)(projectRoot, { ...options,
    mode
  });
}
