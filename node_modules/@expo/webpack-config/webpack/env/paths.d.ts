 ...
 * @category env
 */
export declare function getPaths(projectRoot: string, mode?: string): FilePaths;
/**
 ...
 * @category env
 */
export declare function getPathsAsync(projectRoot: string, mode?: string): Promise<FilePaths>;
/**
 ...
 * @category env
 */
export declare function getServedPath(projectRoot: string, mode?: string): string;
/**
 ...
 * @category env
 */
export declare function getProductionPath(projectRoot: string, mode?: string): string;
/**
