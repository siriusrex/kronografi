 ...
 */
function withTypeScriptAsync(config, env = {}) {
    var _a;
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (!isTypeScriptEnabled && ((_a = config.resolve) === null || _a === void 0 ? void 0 : _a.extensions)) {
        ...
        if (!config.plugins)
            config.plugins = [];
        config.plugins.push(new fork_ts_checker_webpack_plugin_1.default(pnp_webpack_plugin_1.default.forkTsCheckerOptions({
            async: isDev,
